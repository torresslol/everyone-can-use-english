...
> ![一只小猫被放置在实验仪器中，展示了关于大脑视觉区域发展的“关键期”的实验记录](images/figure01.png)
...
![一张展示“区域论”的插图，该理论错误地认为大脑像一台机器，每个部位具有特定且不可改变的功能](images/figure02.png)
...
![一个海洋吉普赛男孩的特写，他明亮的眼睛引出了关于人类适应性和大脑可塑性的进一步讨论](images/figure03.png)
